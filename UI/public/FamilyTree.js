...
(FamilyTree._defaultConfig = function (e) {
        ...
        if (!FamilyTree.LAZY_LOADING || this.isVisible)
            if (FamilyTree.LAZY_LOADING || this._initialized || (this._setInitialSizeIfNotSet(), 0 != this.width() && 0 != this.height())) {
                ...
                this.manager.read(
                    ...
                    i,
                    function (n) {
                        if (!a.notifierUI.show(n.notif) && (!1 !== a.config.lazyLoading || !0 !== e || t === FamilyTree.action.exporting)) {
                            ...
                            if ((FamilyTree.events.publish("render", [a, l]), (o = l.content), (n = l.res), (o += a.ui.lonely(a.config)), t !== FamilyTree.action.exporting)) {
                                (t !== FamilyTree.action.centerNode && t !== FamilyTree.action.insert && t !== FamilyTree.action.expand && t !== FamilyTree.action.collapse && t !== FamilyTree.action.update) || (c = d),
                                ...
                                t === FamilyTree.action.centerNode
                                    ...
                                    : !d ||
                                      !a.response ||
                                      (d[0] == a.response.viewBox[0] && d[1] == a.response.viewBox[1] && d[2] == a.response.viewBox[2] && d[3] == a.response.viewBox[3]) ||
                                    ...
                                    ? 0 == g[0].length && (y || (r && r(), FamilyTree.events.publish("redraw", [a]), (y = !0)))
                                    : FamilyTree.animate(a.getSvg(), { viewbox: d }, { viewbox: a.response.viewBox }, 2 * a.config.anim.duration, a.config.anim.func, function () {
    ...
    (FamilyTree._exportIterateForJSON_XML_CSV = function (e, t, i, r) {
        if (Array.isArray(t)) for (var a = 0; a < t.length; a++) FamilyTree._exportIterateForJSON_XML_CSV(e, t[a], i, r);
        else {
            var n = e.get(t.id);
            if ((r.push(n), i.min)) for (a = 0; a < t.stChildrenIds.length; a++) FamilyTree._exportIterateForJSON_XML_CSV(e, e.getNode(t.stChildrenIds[a]), i, r);
            else for (a = 0; a < t.stChildren.length; a++) FamilyTree._exportIterateForJSON_XML_CSV(e, t.stChildren[a], i, r);
            if (i.expandChildren) for (a = 0; a < t.childrenIds.length; a++) FamilyTree._exportIterateForJSON_XML_CSV(e, e.getNode(t.childrenIds[a]), i, r);
            else for (a = 0; a < t.children.length; a++) FamilyTree._exportIterateForJSON_XML_CSV(e, t.children[a], i, r);
        }
    }),
                ...
                v = function (t) {
                    if (h) {
                        ...
                        var o = FamilyTree._getOffsetXY(l.element, t),
                            s = { left: l.width() - (o.x + l.config.padding) < 0, right: o.x - l.config.padding < 0, up: l.height() - (o.y + l.config.padding) < 0, down: o.y - l.config.padding < 0 };
                ...
                g = function (t) {
                    if (c) {
                        ...
                        var a = FamilyTree._getOffsetXY(s.element, t),
                            g = { left: s.width() - (a.x + s.config.padding) < 0, right: a.x - s.config.padding < 0, up: s.height() - (a.y + s.config.padding) < 0, down: a.y - s.config.padding < 0 };
                        if (g.left || g.right || g.up || g.down) {
                            ...
                            var A = (i.x - c.x) / f,
                                E = (i.y - c.y) / f;
                            if (((m[4] = p + A), (m[5] = h + E), !e._dragEventFired && (Math.abs(i.x - c.x) > FamilyTree.FIRE_DRAG_NOT_CLICK_IF_MOVE || Math.abs(i.y - c.y) > FamilyTree.FIRE_DRAG_NOT_CLICK_IF_MOVE)))
            ...
            if (!this._moveInterval) {
                ...
                FamilyTree.isNEU(i) && (i = FamilyTree.anim.inSin),
                    ...
                    (this._moveInterval = setInterval(function () {
                        ...
                        e.left ? (o++, (c.x = (o * FamilyTree.MOVE_STEP) / l), (c.xWithoutScale = o * FamilyTree.MOVE_STEP)) : e.right && (o++, (c.x = (-o * FamilyTree.MOVE_STEP) / l), (c.xWithoutScale = -o * FamilyTree.MOVE_STEP)),
                            e.up ? (s++, (c.y = (s * FamilyTree.MOVE_STEP) / l), (c.yWithoutScale = s * FamilyTree.MOVE_STEP)) : e.down && (s++, (c.y = (-s * FamilyTree.MOVE_STEP) / l), (c.yWithoutScale = -s * FamilyTree.MOVE_STEP));
                        var m = i((10 * d - 10) / r);
    ...
    (FamilyTree.manager._createNodes = function (e) {
        ...
        for (c = 0; c < C.length; c++) {
            ...
            for (F = A.length - 1; F >= 0; F--) if (E[A[F]]) for (u = 0; u < E[A[F]].length; u++) g.children.push(o[E[A[F]][u]]), L++, -1 == B.indexOf(A[F]) && B.push(A[F]);
            for (F = 0; F < I.length; F++) {
                var z = o[I[F]];
                g.children.push(z);
            }
            for (F = 0; F < N.length; F++) if (E[N[F]]) for (u = 0; u < E[N[F]].length; u++) g.children.push(o[E[N[F]][u]]), O++, -1 == U.indexOf(N[F]) && U.push(N[F]);
        ...
        for (var $ in w) {
            ...
            for (F = X.length - 1; F >= 0; F--)
                if (F % 2 && F != X.length - 1) {
                    ...
                    FamilyTree.manager._initDinamicNode(W, b.lcn, !0), (o[W.id] = W), X.splice(F, 0, W.id), V++;
